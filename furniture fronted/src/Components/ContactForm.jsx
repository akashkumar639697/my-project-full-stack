...
function ContactForm() {
  ...
  //////////////////////////////////////////////
  let [formData1, setFromData1] = useState({ firstName: "Akash" })
  let [formData2, setFromData2] = useState({ lastName: "Kumar" })
  let [formData3, setFromData3] = useState({ email: "akashkumar639697@gmail.com" })
  let [formData4, setFromData4] = useState({ message: "hello , I am Akash" })
